...
// todo додавання повного екрану для мобілки
...
//     const viewerEl = containerRef.current;
//     if (viewerEl.requestFullscreen) {
//       viewerEl.requestFullscreen().catch(() => setIsFullscreenFallback(true));
//     } else if (viewerEl.webkitRequestFullscreen) {
//       viewerEl.webkitRequestFullscreen();
//     } else if (viewerEl.mozRequestFullScreen) {
//       viewerEl.mozRequestFullScreen();
...
//         <div
//           ref={containerRef}
//           className={`${styles.viewerContainer} ${fade ? styles.fadeOut : ''} ${
//             isFullscreenFallback ? styles.fullscreenMobile : ''
//           }`}
//         >
//           {panoramaUrl.length > 1 && (
//             <div className={styles.controls}>
...
//               <button className={styles.button} onClick={exitFullscreenFallback}>
//                 ❌ {lang === i18n.locales[0] ? 'Вийти з повноекранного' : 'Exit Fullscreen'}
//               </button>
//             </div>
//           )}
//         </div>
