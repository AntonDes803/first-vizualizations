export const functionalDesignInterior = {
    ...
    cardTextEn: "Key points to help make your space comfortable and aesthetically pleasing...",
    creatingData: "18.04.2025",
    mainTextUk: "Функціональний інтер’єр - це не просто красивий простір, а місце, яке підлаштовується під ваш стиль життя, потреби й звички. Якщо кожна деталь працює на комфорт, а дизайн допомагає, а не заважає, - вітаємо, у вас дійсно продуманий інтер’єр! Як цього досягти? Ось ключові принципи, що допоможуть створити простір, у якому вам буде зручно та затишно.",
    mainTextEn: "A functional interior is not just a beautiful space, but a place that adapts to your lifestyle, needs, and habits. If every detail works for comfort, and the design helps rather than hinders, congratulations, you have a truly thoughtful interior! How to achieve this? Here are the key principles that will help you create a space where you feel comfortable and cozy.",
    blocks: [
      {
