...
export const servicesData = [
  {
    ...
    categoryEn: '',
    cardTextUk: 'Створюємо комфортні, стильні та функціональні інтер’єри для квартир будь-якої площі.',
    cardTextEn: '',
    projectsCount: '45',
    titleUk: 'Особливості розробки дизайну квартири',
    titleEn: '',
    text1Uk: 'Продуманий дизайн інтер’єру створює гармонійний простір, який відображає ваш стиль життя. Ми враховуємо кожну деталь, поєднуючи естетику, комфорт та функціональність.',
    text1En: '',
    text2Uk: "Наш підхід передбачає ретельне планування, зонування та використання якісних матеріалів. Завдяки цьому ви отримуєте не просто красивий інтер’єр, а продумане рішення для комфортного життя.",
    text2En: "",
  ...
  },
  {
    ...
    categoryEn: '',
    cardTextUk: "Розробляємо концепції, що враховують архітектуру, ландшафт і особливості вашого будинку.",
    cardTextEn: "",
    projectsCount: "45",
    titleUk: "",
    titleEn: "",
  ...
  },
  {
    ...
    categoryEn: '',
    cardTextUk: 'Розробка унікальних рішень для бізнесу: магазини, офіси, ресторани, готелі.',
    cardTextEn: '',
    projectsCount: '45',
    titleUk: '',
    titleEn: '',
  ...
  },
  {
    ...
    categoryEn: '',
    cardTextUk: 'Комплексне створення будівель: від ескізу до робочої документації.',
    cardTextEn: '',
    projectsCount: '45',
    titleUk: '',
    titleEn: '',
    ...
    imageMain: '/images/dev/servicesPage/all-services-architectural-design.webp',
  },
];
